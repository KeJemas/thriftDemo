...
public class ThriftNacosServerListUpdater implements ServerListUpdater {

    private static final Logger LOGGER = LoggerFactory.getLogger(ThriftNacosServerListUpdater.class);
    ...
    public ThriftNacosServerListUpdater() {
        this(30000);
    }

    public ThriftNacosServerListUpdater(long refreshIntervalMs) {
        this(0, refreshIntervalMs);
    }

    public ThriftNacosServerListUpdater(long initialDelayMs, long refreshIntervalMs) {
    ...
    private static class LazyHolder {
        ...
        static {
            ThreadFactory factory = new ThreadFactoryBuilder()
                    .setNameFormat("ThriftNacosServerListUpdater-%d")
                    .setDaemon(true)
                    .build();
            ...
            shutdownThread = new Thread(() -> {
                LOGGER.info("Shutting down the Executor Pool for ThriftNacosServerListUpdater");
            ...
            if (serverListRefreshExecutor != null) {
                ...
                if (shutdownThread != null) {
                    try {
                        ...
                        LOGGER.error("Failed to shutdown the Executor Pool for ThriftNacosServerListUpdater", e);
                    }
                }
