...
import ut.pcmspf.common.rpc.thrift.client.exception.ThriftClientInstantiateException;
...
//                if(injectedBeanMap.entrySet().isEmpty()){
//                	throw new ThriftClientInstantiateException("Detected non-qualified bean of {}" + fieldType.getSimpleName());
//                }
//                injectedBean = injectedBeanMap.entrySet().iterator().next();
...
//                                "Detected non-qualified bean of {}" + parameterType.getSimpleName()));
                ...
                return injectedBeanMap.entrySet().iterator().next();
